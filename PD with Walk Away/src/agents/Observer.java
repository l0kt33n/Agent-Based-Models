...
public class Observer implements Steppable {
	...
	private void countAndReset() {
		nNaiveC = nNaiveD = nWalkawayC = nWalkawayD = nTFTStationary = nTFTMobile = nPAVLOVStationary = nPAVLOVMobile=nRealisticTFT = 0;	// reset counters
	...
	private void printDataline() {
		...
		System.out.println(steps + "\t" + nNaiveC + "\t" + nNaiveD + "\t" + nWalkawayC + "\t" + nWalkawayD + "\t" + nTFTStationary + "\t" + nTFTMobile + "\t" + nPAVLOVStationary + "\t" + nPAVLOVMobile + "\t" + nRealisticTFT);
		return;
	}
	...
	private void printHeaders() {
		System.out.println("step\tnNaiveC\tnNaiveD\tnWalkawayC\tnWalkawayD\tnTFTStationary\tnTFTMobile\tnPAVLOVStationary\tnPAVLOVMobile\tnRealisticTFT");
		return;
	}
